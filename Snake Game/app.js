document.addEventListener("DOMContentLoaded", () => {
  ...
  const width = 10;
  let currrentIndex = 0; //so first div in our grid
  ...
  function moveOutcomes() {
    ...
    if (
      ...
      return clearInterval(interval); //this will clear the interval if any of the following have occured
    }

    const tail = currentSnake.pop(); //removes last item of the array and shows setInterval
  ...
  function control(e) {
    squares[currrentIndex].classList.remove("snake");
